 ...
 * Game and calls methods of Game object such as update and draw.
 * 
 */

public class GameLoopThread extends Thread {
	
	private final static int FPS  = 60;          		// How many times per second the game should be updated, drawn?
	private final static int MAX_FRAME_SKIPS = 5; 			// Maximum number of frames to be skipped
	private final static int FRAME_PERIOD = 100 / FPS;    // The time for one frame 
